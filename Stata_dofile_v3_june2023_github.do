...
/* This analysis is based on a cluster-based survey with variable cluster size. The clusters are distributed across three different strata. */
/* Clusters in the same strata enrol consecutive patients over the same period of time until the strata sample size is met. */

/* Set working drive */
cd "C:\x\x\........" /* change working drive to match yours */
