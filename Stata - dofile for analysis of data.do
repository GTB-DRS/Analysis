...
/* see powerpoint slide "Patient enrolment flowchart" */
...
categories of other key variables in the dataset. Results from this analysis are given in the Excel file, "Analysis results" and will inform the multiple imputation model. */
...
svyset cluster [pw=pweight_restricted] /* we are applying the same weights applied for the non-imputed analysis of RR-TB plus robust standard errors to account for clustering */
logit mdr if treat_hist==0
di invlogit(_b[_cons])
di invlogit(_b[_cons] - invnormal(0.975)*_se[_cons])
di invlogit(_b[_cons] + invnormal(0.975)*_se[_cons])

logit mdr if treat_hist==1
di invlogit(_b[_cons])
di invlogit(_b[_cons] - invnormal(0.975)*_se[_cons])
di invlogit(_b[_cons] + invnormal(0.975)*_se[_cons])
...
svyset cluster [pw=pweight_restricted] /* we are applying the same weights applied for the non-imputed analysis of RR-TB plus robust standard errors to account for clustering */
logit lfxPheno if treat_hist==0
di invlogit(_b[_cons])
di invlogit(_b[_cons] - invnormal(0.975)*_se[_cons])
di invlogit(_b[_cons] + invnormal(0.975)*_se[_cons])

logit lfxPheno if treat_hist==1
di invlogit(_b[_cons])
di invlogit(_b[_cons] - invnormal(0.975)*_se[_cons])
di invlogit(_b[_cons] + invnormal(0.975)*_se[_cons])
...
logit preXdr if treat_hist==0
di invlogit(_b[_cons])
di invlogit(_b[_cons] - invnormal(0.975)*_se[_cons])
di invlogit(_b[_cons] + invnormal(0.975)*_se[_cons])

logit preXdr if treat_hist==1
di invlogit(_b[_cons])
di invlogit(_b[_cons] - invnormal(0.975)*_se[_cons])
di invlogit(_b[_cons] + invnormal(0.975)*_se[_cons])

logit xdr if treat_hist==0
di invlogit(_b[_cons])
di invlogit(_b[_cons] - invnormal(0.975)*_se[_cons])
di invlogit(_b[_cons] + invnormal(0.975)*_se[_cons])

logit xdr if treat_hist==1
di invlogit(_b[_cons])
di invlogit(_b[_cons] - invnormal(0.975)*_se[_cons])
di invlogit(_b[_cons] + invnormal(0.975)*_se[_cons])
